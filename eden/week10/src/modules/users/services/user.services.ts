...
import { DuplicateUserEmailError, UserNotExist } from "../../../common/errors/errors.js";
import { UserUpdateRequest } from "../dtos/user.dtos.js";
...
export const updateUserInfo = async (userId: number, data: UserUpdateRequest) => {
  ...
  if (!user) throw new UserNotExist("존재하지 않는 사용자입니다.");
