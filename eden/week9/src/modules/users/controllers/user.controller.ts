...
import { bodyToUser, UserDto, UserSignUpRequest, UserSignUpResponse, UserUpdateRequest } from "../dtos/user.dtos.js";
import { updateUserInfo, userSignUp } from "../services/user.services.js";
...
@Response<UserErrorResponse>(500, "서버 내부 오류")
  ...
  /**
   * 내 정보 수정 API
   * @summary 로그인한 사용자 본인의 정보를 수정하는 엔드포인트입니다.
   */
  @Patch("me")
  @Middlewares(authorizeUser())
  @SuccessResponse(200, "수정 성공")
  @Response<UserErrorResponse>(401, "인증이 필요합니다")
  @Response<UserErrorResponse>(404, "존재하지 않는 사용자입니다")
  @Response<UserErrorResponse>(500, "서버 내부 오류")
