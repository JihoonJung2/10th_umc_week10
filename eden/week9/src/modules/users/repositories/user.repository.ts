...
import { UserDto, UserPreferenceItemDto, UserUpdateRequest } from "../dtos/user.dtos.js";
...
export const updateUser = async (userId: number, data: UserUpdateRequest): Promise<UserDto> => {
